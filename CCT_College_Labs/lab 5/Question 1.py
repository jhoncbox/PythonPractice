...
def main():
    ...
    account2 = Account(1123,20000,5.5)
    ...
    print("ID is", account2.getId())
    print("Balance is", account2.getBalance())
    print("Monthly interest rate is", account2.getMonthlyInterestRate())
    print("Monthly interest is", account2.getMonthlyInterest())
